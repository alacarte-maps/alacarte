...
#pragma once
#ifndef CHILDWAYS_SELECTOR_HPP
#define CHILDWAYS_SELECTOR_HPP
/*
 * =====================================================================================
 *
 *       Filename:  childways_selector.hpp
 *
 *    Description:  "way" - selector for all way children of the parent relation
 *
 * =====================================================================================
 */
...
class ChildWaysSelector : public Selector {
public:
	ChildWaysSelector(const std::shared_ptr<Rule>& rule, const std::shared_ptr<Selector>& next);
