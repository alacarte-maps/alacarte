...
#pragma once
#ifndef HASTAG_SELECTOR_HPP
#define HASTAG_SELECTOR_HPP
/*
 * =====================================================================================
 *
 *       Filename:  hastag_selector.hpp
 *
 *    Description:  [tag] - selector for all objects that have this tag specified
 *
 * =====================================================================================
 */
...
public:
	HasTagSelector(const std::shared_ptr<Rule>& rule, const std::shared_ptr<Selector>& next, const std::string& tag);
