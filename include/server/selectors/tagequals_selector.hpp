...
#pragma once
#ifndef TAGEQUALS_SELECTOR_HPP
#define TAGEQUALS_SELECTOR_HPP
/*
 * =====================================================================================
 *
 *       Filename:  tagequals_selector.hpp
 *
...
public:
	TagEqualsSelector(const std::shared_ptr<Rule>& rule, const std::shared_ptr<Selector>& next, const std::string& tag, const std::string& value);
