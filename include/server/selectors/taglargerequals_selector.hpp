...
#pragma once
#ifndef TAGLARGEREQUALS_SELECTOR_HPP
#define TARLARGEREQUALS_SELECTOR_HPP
/*
 * =====================================================================================
 *
 *       Filename:  taglargerequals_selector.hpp
 *
...
class TagLargerEqualsSelector : public Selector {
public:
	TagLargerEqualsSelector(const std::shared_ptr<Rule>& rule, const std::shared_ptr<Selector>& next, const std::string& tag, const int& value);
