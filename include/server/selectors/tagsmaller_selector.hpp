...
#pragma once
#ifndef TAGSMALLER_SELECTOR_HPP
#define TAGSMALLER_SELECTOR_HPP
/*
 * =====================================================================================
 *
 *       Filename:  tagsmaller_selector.hpp
 *
...
class TagSmallerSelector : public Selector {
public:
	TagSmallerSelector(const std::shared_ptr<Rule>& rule, const std::shared_ptr<Selector>& next, const std::string& tag, const int& value);
