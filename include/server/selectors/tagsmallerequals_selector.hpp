...
#pragma once
#ifndef TAGSMALLEREQUALS_SELECTOR_HPP
#define TAGSMALLEREQUALS_SELECTOR_HPP
/*
 * =====================================================================================
 *
 *       Filename:  tagsmallerequals_selector.hpp
 *
...
class TagSmallerEqualsSelector : public Selector {
public:
	TagSmallerEqualsSelector(const std::shared_ptr<Rule>& rule, const std::shared_ptr<Selector>& next, const std::string& tag, const int& value);
