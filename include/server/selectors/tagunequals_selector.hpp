...
#pragma once
#ifndef TAGUNEQUALS_SELECTOR_HPP
#define TAGUNEQUALS_SELECTOR_HPP
/*
 * =====================================================================================
 *
 *       Filename:  tagunequals_selector.hpp
 *
...
public:
	TagUnequalsSelector(const std::shared_ptr<Rule>& rule, const std::shared_ptr<Selector>& next, const std::string& tag, const std::string& value);
