...
TagSmallerEqualsSelector::TagSmallerEqualsSelector(const std::shared_ptr<Rule>& rule, const std::shared_ptr<Selector>& next, const std::string& tag, const int& value)
	: Selector(rule, next)
	, tag(tag)
	, value(value)
{
